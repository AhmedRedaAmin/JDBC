...
public class TabelImp {
    ...
    /*public void InsertInPlace(String ColName, Object value) {
        int colmIndex = getIndex(ColName); 
        DBNode x = getFromTable(colmIndex);
        LinkedList<Object> y = x.getColumn();
        y.add(value);
        x.setColumn(y);
        Colomes.remove(colmIndex);
        Colomes.add(x);
    }*/
}